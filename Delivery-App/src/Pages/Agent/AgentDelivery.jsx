...
import { editAgentStatus, getAgentOrderPickuped, getUserOrderById } from "../Services/All_Api";
              ...
              <div>
                <label className="font-semibold p-2" htmlFor="">
                  <input className="m-2" type="checkbox"
                   checked={editOrderStatus === "Delivered"}
                   onChange={(e) => setEditOrderStatus(e.target.checked ? "Delivered" : "")} />Delivered
                </label>
